...
function UserRegister({ navigation }) {
  ...
  const onSignUp = () => {
    ...
    if (avatarsource == "") {
      ...
      Toast.showWithGravity('Please input age.', Toast.SHORT, Toast.TOP);
    } else if (isNaN(age)) {
      Toast.showWithGravity('Please input correct age.', Toast.SHORT, Toast.TOP);
    } else {
      ...
      auth()
        ...
        .then(() => {
          ...
          Toast.showWithGravity('User account created', Toast.SHORT, Toast.TOP);
          navigation.pop();
        })
        .catch(error => {
    ...
    <LinearGradient colors={['#001144', '#001144']} style={styles.linearGradient}>
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View style={{ flexDirection: 'column', justifyContent: 'center', marginTop: 20, width: '80%', alignSelf: 'center', marginTop: '10%' }}>
          ...
          <KTextInput placeholder="User Name" onChangeText={username => setUserName(username)} />
